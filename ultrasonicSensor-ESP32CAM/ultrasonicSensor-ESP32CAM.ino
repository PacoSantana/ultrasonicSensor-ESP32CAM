 ...
 * en su version 3.0.0. Se mezcla con el programa ESP32CAM_MQTT-Basic tomado del github
 * de Codigo IoT
 * 
...
//Datos de WiFi
const char* ssid = "INFINITUM4r33";  // Aquí debes poner el nombre de tu red
const char* password = "4d07244b5d";  // Aquí debes poner la contraseña de tu red

//Datos del broker MQTT
const char* mqtt_server = "3.127.110.141"; // Si estas en una red local, coloca la IP asignada, en caso contrario, coloca la IP publica
IPAddress server(3,127,110,141);
